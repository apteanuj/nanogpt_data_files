Total params:
\[
P = 38{,}633{,}472 + 123{,}568{,}128 = 162{,}201{,}600
\]

Chinchilla tokens (≈20× params):
\[
T_\star \approx 20 P = 3{,}244{,}032{,}000
\]

Tokens per step:
\[
\text{tokens/step} = B_{\text{eff}} \cdot L
\]

Required steps:
\[
\text{steps}_\star = \frac{T_\star}{B_{\text{eff}} \cdot L}
\]

Example with \(L = 1024\):

- If `batch-size` is : \(B_{\text{eff}} = 512\)
  \[
  \text{tokens/step} = 512 \cdot 1024 = 524{,}288
  \]
  \[
  \text{steps}_\star \approx \frac{3{,}244{,}032{,}000}{524{,}288} \approx 6{,}188 \approx 6200
  \]
