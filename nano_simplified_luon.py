...
from utils import Muon, DistributedDataLoader, GPT, GPTConfig, Luon, Gluon
...
luon_lr = float(os.environ.get("LUON_LR", "0.001"))
luon_wd = float(os.environ.get("LUON_WD", "0.3"))
beta1 = 0.9
beta2 = 0.95
# optimizer1 = Luon(raw_model.lm_head.parameters(), lr=luon_lr, betas=(beta1, beta2))
# optimizer2 = Luon(raw_model.transformer.h.parameters(), lr=luon_lr, betas=(beta1, beta2))
optimizer1 = Gluon(raw_model.lm_head.parameters(), lr=0.001, betas=(beta1, beta2), weight_decay=luon_wd)
optimizer2 = Gluon(raw_model.transformer.h.parameters(), lr=luon_lr, betas=(beta1, beta2), weight_decay=luon_wd)
